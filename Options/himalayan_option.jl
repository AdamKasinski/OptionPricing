...
function price_himalayan_LHS(r, basket_volume, S₀, mu, sigma, correlation_matrix) # TODO: add types
    T = basket_volume*250
...
function price_himalayan_moment_matching(r, basket_volume, S₀, mu, sigma, correlation_matrix) # TODO: add types
    #
    T = basket_volume*250
    d = Normal()
    Z = rand(d,(basket_volume,T))
